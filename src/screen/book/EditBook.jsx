...
const EditBook = () => {
    ...
    const { getCategoryList, category, getSubCategoryList, subcategory } = useCommonContext();
    ...
    return (
        <>
            <CommonBreadcrumb title="Edit Book" />
            ...
            <div className="product-form-container p-3">
                ...
                >
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-9">
                                <FormGroup>
                                    ...
                                    <textarea className="form-control" name="description" value={inputData.description} onChange={handleInputChange} rows="3" />
                                </FormGroup>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="row">
                            ...
                            {inputData.has_hardcopy && (
                                <>
                                    ...
                                    <div className="col-md-3">
                                        <Label>Is Sale?</Label>
                                        <Input type="select" name="hardcopy_is_sale" value={inputData.hardcopy_is_sale} onChange={handleInputChange}>
                                            <option value="false">No</option>
                                            <option value="true">Yes</option>
                                        </Input>
                                    </div>

                                    {inputData.hardcopy_is_sale && (
                                        <>
                        ...
                        <div className="row">
                            ...
                            {inputData.has_softcopy && (
                                <>
                                    ...
                                    <div className="col-md-3">
                                        <Label>Is Sale?</Label>
                                        <Input type="select" name="softcopy_is_sale" value={inputData.softcopy_is_sale} onChange={handleInputChange}>
                                            <option value="false">No</option>
                                            <option value="true">Yes</option>
                                        </Input>
                                    </div>

                                    {inputData.softcopy_is_sale && (
                                        <>
                                            <div className="col-md-3">
                                                <Label>Offer Price</Label>
                    ...
                    <div className="text-end">
                        <Button color="primary">Submit Book</Button>
                    </div>
                </form>
            </div>
        </>
